  ...
  const projects = [
    {
      ...
      description:
        "A business website for Darkhorse LLC. built from start to finish within one week. The website utilizes Next.js as the frontend framework and Tailwind library for an aestheically pleasing minimal design. Implemented Google Analytics 4 to monitor traffic and track page views.",
      technologies:
