    ...
    <div className="max-w-screen-lg mx-auto px-3 md:px-6">
      ...
      <div className="grid lg:grid-cols-2 gap-8">
        ...
        <div className="flex flex-wrap content-center pb-8">
          ...
          <p><span className="font-semibold">Technologies: </span>HTML5, CSS3, PostgreSQL, Express.js, React.js, Node.js</p>
        </div>
        ...
        <div className="flex flex-wrap content-center">
          ...
          <p><span className="font-semibold">Technologies: </span> HTML, CSS, JavaScript</p>
        </div>
      </div>
    </div>
  );
